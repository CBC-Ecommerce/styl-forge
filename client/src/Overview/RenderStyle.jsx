  ...
  return (
    <div>
      {(selectedStyle.style_id.toString() === style.style_id.toString()) ? (
        <button className="style-thumbnail-buttons" id={style.style_id} type="button" aria-abel={`Current style, ${selectedStyle.name}`} onClick={(e) => {
        ...
        <button className="style-thumbnail-buttons" id={style.style_id} type="button" aria-abel={`Select ${selectedStyle.name} style`} onClick={(e) => {
          styleSelectClickHandler(e);
        }}>
